      ...
      <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white dark:bg-gray-800 rounded-2xl shadow-2xl lg:max-w-4xl  duration-300">
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          ...
          <div
            ...
            className="flex cursor-pointer items-center justify-center mt-4 hover:   duration-300 transform border rounded-lg   hover:bg-gray-50 "
          >
            ...
            <span className="w-5/6 px-4 py-3 font-bold text-center  hover:">
              Sign in with Google
            </span>
          </div>

          <div className="flex items-center justify-between mt-4">
            <span className="w-1/5 border border-white  lg:w-1/4"></span>
          ...
          <form onSubmit={signInWithEmailAndPassword}>
            <div className="mt-4">
              ...
              <input
                ...
                placeholder="Name"
                name="name"
                className="block w-full px-4 py-2    bg-gray-300 rounded-lg    focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300"
                type="text"
              />
            </div>
            <div className="mt-4">
            ...
            <div className="mt-6">
              <button className="w-full px-6 py-3 text-sm font-medium tracking-wide  capitalize  duration-300 transform bg-gray-700 rounded-lg hover:bg-gray-900 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50">
                Sign Up
              </button>
            </div>
          </form>
          ...
          <div className="flex items-center justify-between mt-4">
            <span className="w-1/5 border-b border-b-white md:w-1/4"></span>
